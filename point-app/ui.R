...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(width = 2,
                 ...
                 radioButtons('scn', 'Scenario group', choiceNames = c('All', '2009', 'Hypothetical'), 
                              choiceValues = c('ALL', 'RL', 'HP'))
    ),
    ...
    mainPanel(
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Traj.", plotOutput("trajPlot", height = '800px')),
                  ...
                  tabPanel("Peak-Diff", plotOutput("peakPlotDiff", height = '800px')),
