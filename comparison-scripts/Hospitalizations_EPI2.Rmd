---
title: "Hospitalizations - EPI2 Scenarios"
...
table$`Averted Hospitalizations per 100K (HP13)` <- ifelse(table$Team %in% table1$Team, table1$`Cum. Hospitalizations per 100K` - table$`Cum. Hospitalizations per 100K`, NA)
