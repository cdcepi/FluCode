...
#Bar chart for age stratification
...
table$`% Reduction in Burden (HP13)` <- ifelse(table$Team %in% table1$Team, 100 * (table1$`Cum. Hospitalizations per 100K` - table$`Cum. Hospitalizations per 100K`) / table1$`Cum. Hospitalizations per 100K`, NA)
...
averted_age <- rbind(averted_age, data.frame(scenario = scenario,
                                             ...
                                             agegroup = ages$Agegroup,
                                             reduction = 100*(ages_1$Cml - ages$Cml) / ages_1$Cml ))
write.csv(averted, "Hospitalizations_EPI2.csv")
write.csv(averted_age, "Hospitalizations_age_EPI2.csv")
```