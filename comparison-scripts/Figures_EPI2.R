...
p1 <- ggplot(s, aes(x = team, y = cml, color=team)) +
  ...
  # ggtitle("c. Age-specific symptomatic percentages in EPI2 no intervention scenario (HP13)")+
  ggtitle("c.")+
  theme(
...
p2 <- ggplot(d, aes(x = team, y = cml, color=team)) + 
  ...
  # ggtitle("d. Age-specific death rates per 100,000 in EPI2 no intervention scenario (HP13)")+
  ggtitle("d.")+
  theme(
    axis.text.x = element_blank(),
    # axis.text.y = element_text(size=13),
...
png("fig2_EPI2.png",res=220, 1600, 1000)
...
long_ens <- read.csv(paste0(path, "MeanBased-Ensemble/PAN2_symillness_ensemble.csv"))
...
png("fig1_EPI2.png",res=220, 1600, 1000)
ggplot(data = long_ens, aes(x = Date, y = HP13_mean, group = team)) +
  geom_line(aes(color = team), lwd = 1.5) +
  geom_ribbon(aes(ymin = HP13_perc2p5, ymax = HP13_perc97p5, fill = team), alpha = 0.15,
              show.legend = FALSE)+
...
age_ill <- read.csv(paste0(path, "MeanBased-Ensemble/PAN2_symillness_base_age.csv"))
...
age_dead <- read.csv(paste0(path, "MeanBased-Ensemble/PAN2_death_base_age.csv"))
...
png("fig7_EPI2.png",width = 900, height=1000, res = 220)
...
png("fig3_EPI2.png",width = 2500, height=1600, res=220)
ggarrange(p6, p3, nrow=2, ncol=1)#,common.legend = TRUE, legend="bottom")
dev.off()

png("fig3_cd_EPI2.png",width = 2500, height=1600, res = 220)
...
png("figh3_EPI2.png",width = 2500, height=3200, res = 220)
...
png("figd3_EPI2.png",width = 2500, height=3200, res = 220)
