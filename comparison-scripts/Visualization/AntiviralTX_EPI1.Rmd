---
title: "Antivirals - EPI1 Scenarios"
...
EPI1: R0 1.4 and “2009-like” severity
...
table$`Averted % AntiviralTX (HP01)` <- ifelse(table$Team %in% table1$Team, table1$`Cumulative % AntiviralTX` - table$`Cumulative % AntiviralTX`, NA)

rownames(table) <- NULL

knitr::kable(table[5:7], digits = 2, caption = "HP08", align=rep('c', 4)) %>%
...
knitr::kable(table[5:7], digits = 2, caption = "HP09", align=rep('c', 4)) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
...
knitr::kable(table[5:7], digits = 2, caption = "HP10", align=rep('c', 4)) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
...
knitr::kable(table[5:7], digits = 2, caption = "HP11", align=rep('c', 4)) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
...
knitr::kable(table[5:7], digits = 2, caption = "HP12", align=rep('c', 4)) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
