...
plot_ages_1 <- ages_1[which(ages_1$Bin == "sm.mean"),]
ggplot(plot_ages_1[which(plot_ages_1$Agegroup != "Overall"),], aes(fill=Agegroup, y=Cml, x=team)) + 
...
write.csv(averted_age, "SympIllnesses_2009_RL01.csv")
```
...
# t <- table
# t$vax_av_burden <- (t$`Absolute Averted % Ill (RL01)` / 100) * 306.8e6
# write.csv(t, "2009_vax_averted.csv")
